...
public class LeavesDisease extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leaves_disease);
    ...
    private void showresult(){
        ...
        Log.d("probability", "showresult: "+labeledProbability.toString());
